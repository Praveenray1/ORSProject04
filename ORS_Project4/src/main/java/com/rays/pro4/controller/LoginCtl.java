...
public class LoginCtl extends BaseCtl {
	...
	protected BaseBean populateBean(HttpServletRequest request) {
		...
		bean.setId(DataUtility.getLong(request.getParameter("id")));// get kiya
																	// loginctl
		...
		if (OP_SIGN_IN.equalsIgnoreCase(op)) {
			...
			try {
				...
				if (bean != null) {
					...
					// if-else pura code role or front controller access ke liye
					// kiya hai
			 ...
			 * System.out.println(" Lctl Do post 44");
			 * 
