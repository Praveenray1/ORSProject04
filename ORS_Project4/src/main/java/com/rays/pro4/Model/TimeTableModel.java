...
public class TimeTableModel {
	...
	public long add(TimeTableBean bean) throws ApplicationException, DuplicateRecordException {
		...
		// TimeTableBean bean1 = checkBycds(bean.getCourseId(),
		// bean.getSemester(), new java.sql.Date(bean.getExamDate().getTime()));
		// TimeTableBean bean2 = checkBycss(bean.getCourseId(),
		// bean.getSubjectId(), bean.getSemester());
